...
export class FakeApiClient implements IApiClient {
  ...
  onUploadFile: (payload: unknown) => Promise<RpcResponse<{ path: string }>> =
    () => Promise.resolve(ok({ path: '/fixture/.dsh/attachments/uploaded.txt' }))
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    uploadFile: (payload: unknown) => this.record('session.uploadFile', payload, this.onUploadFile(payload)),
