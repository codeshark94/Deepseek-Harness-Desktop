...
/** Uploaded workspace file represented by an inline draft reference. */
export interface ComposerFileAttachment {
  /** Stable occurrence identity inside the input machine. */
...
export interface ComposerAttachmentsOwnerProps {
  ...
  /** Uploaded workspace files in input occurrence order. */
  ...
  /** Remove one uploaded file reference from the draft. */
  onRemoveFile: (occurrenceId: number) => void
...
export interface ConversationInjected {
   ...
   * `undefined` starts an "Ungrouped" conversation without a Workspace.
   */
...
export interface EmptyWorkspaceOwnerProps {
  ...
  /** `undefined` selects "Ungrouped" (start a conversation without a Workspace folder). */
