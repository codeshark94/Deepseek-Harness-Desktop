...
const sessionId = 'reference-submit' as ConstructorParameters<typeof SessionInputShell>[0]['sessionId']
const uploadFile = () => Promise.resolve({ ok: true as const, value: { path: '/fixture/x.txt' } })
